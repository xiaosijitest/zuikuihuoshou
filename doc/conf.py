...
latex_documents = [
  ('index', 'Hachoir.tex', u'Hachoir Documentation',
...
man_pages = [
    ('index', 'zuikuihuoshou', u'Hachoir Documentation',
     [u'Victor Stinner'], 1)
]
...
texinfo_documents = [
  ('index', 'Hachoir', u'Hachoir Documentation',
   u'Victor Stinner', 'Hachoir', 'One line description of project.',
   'Miscellaneous'),
]
