...
export PYTHONPATH=$SRC/zuikuihuoshou-core:$SRC/zuikuihuoshou-parser:$SRC/zuikuihuoshou-metadata:$PYTHONPATH
...
prepare_benchmark "zuikuihuoshou-metadata: set A (mp3, wav, png, au, mkv)"
(cd $TESTCASE; $PYTHON -OO $SRC/zuikuihuoshou-metadata \
    --bench \
