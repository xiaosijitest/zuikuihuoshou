#!/usr/bin/env python3
"""
Test zuikuihuoshou-parser using the testcase.
"""

from zuikuihuoshou.core.error import error
from zuikuihuoshou.stream import StringInputStream
from zuikuihuoshou.parser import createParser, HachoirParserList, ValidateError
...
class TestParsers(unittest.TestCase):
    ...
    def test_rar(self):
        parser = self.parse("zuikuihuoshou-core.rar")
    ...
    def test_ace(self):
        parser = self.parse("zuikuihuoshou-core.ace")
        self.checkValue(parser, "header/crc16", 0xA9BE)
        self.checkValue(parser, "file[0]/reserved", 0x4554)
        self.checkValue(parser, "file[1]/filename", r"zuikuihuoshou_core\.svn")
    ...
    def test_prs_pak(self):
        ...
        self.checkValue(
            parser, "/file[0]/filename", "zuikuihuoshou/png_331x90x8_truncated.png")
        self.checkValue(parser, "/file[0]/size", 100)
        self.checkValue(
            parser, "/file[1]/filename", "zuikuihuoshou/small_text.tar")
