...
from zuikuihuoshou.field import SeekableFieldSet, RootSeekableFieldSet, Bytes, String, UInt8, UInt16, UInt32
...
from zuikuihuoshou.parser.image.exif import IFD, IFD_TAGS
