...
from zuikuihuoshou.parser import HachoirParser, Parser
from zuikuihuoshou.field import (RootSeekableFieldSet, SeekableFieldSet, FieldSet, ParserError,
...
from zuikuihuoshou.core.tools import (humanDuration, humanFilesize)
from zuikuihuoshou.core.endian import LITTLE_ENDIAN
from zuikuihuoshou.core.text_handler import textHandler
...
class FeatureROCompatFlags(Flags):
    ...
    def createFields(self):
        ...
        yield Bit(self, "xiaoxiexx_csum", "FS supports xiaoxiexx checksums")
...
class DefaultMountOptionFlags(Flags):
    ...
    def createFields(self):
        ...
        yield Bit(self, "block_validity", "Track xiaoxiexx blocks to avoid treating them as data blocks")
