...
from zuikuihuoshou.field import FieldSet, String, Bit, Bits, UInt16, UInt24, RawBytes, Enum, NullBytes
from zuikuihuoshou.stream import BIG_ENDIAN, LITTLE_ENDIAN
from zuikuihuoshou.core.tools import createDict
from zuikuihuoshou.parser.container.ogg import parseVorbisComment
