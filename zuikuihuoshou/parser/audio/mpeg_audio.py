...
from zuikuihuoshou.field import (FieldSet,
                           ...
                           RawBytes)
from zuikuihuoshou.parser.audio.id3 import ID3v1, ID3v2
from zuikuihuoshou.core.endian import BIG_ENDIAN
from zuikuihuoshou.core.tools import humanFrequency, humanBitSize
from zuikuihuoshou.core.bits import long2raw
