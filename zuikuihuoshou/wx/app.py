...
from zuikuihuoshou.parser.guess import createParser, guessParser
from zuikuihuoshou.stream.input import FileFromInputStream
from zuikuihuoshou.wx.dispatcher import dispatcher_t
from zuikuihuoshou.wx import frame_view, field_view, hex_view, tree_view
from zuikuihuoshou.wx.dialogs import file_open_dialog
from zuikuihuoshou.wx.unicode import force_unicode
from zuikuihuoshou import __version__


class app_t(App):
    def __init__(self, filename=None):
        print("[+] Run zuikuihuoshou-wx version %s" % __version__)
