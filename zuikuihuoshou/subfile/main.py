from zuikuihuoshou.stream import FileInputStream
from zuikuihuoshou.core import config
from zuikuihuoshou.subfile.search import SearchSubfile
...
def parseOptions():
    ...
    common = OptionGroup(parser, "zuikuihuoshou-subfile",
                         "Option of zuikuihuoshou-subfile")
