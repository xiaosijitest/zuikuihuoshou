...
from zuikuihuoshou.core.tools import humanFilesize, humanBitSize, makePrintable
from zuikuihuoshou.core.log import log as zuikuihuoshou_log
...
from zuikuihuoshou.field import Field, MissingField
from zuikuihuoshou.stream import InputFieldStream, InputStreamError, FileInputStream
from zuikuihuoshou.parser import guessParser, HachoirParserList
...
class Walker(ListWalker):
    ...
    def _get(self, pos):
        ...
        if pos.parent and pos.field != pos.parent.field[pos.index]:
            zuikuihuoshou_log.error("assertion failed at urwid_ui.Walker._get")
...
#                    pos = next
    ...
    def save_field(self, path, raw):
        try:
            ...
            zuikuihuoshou_log.error(str(err))
        else:
...
def exploreFieldSet(field_set, args, options={}):
    ...
    msgs = [[], [], 0]
    zuikuihuoshou_log.use_print = False
    ...
    zuikuihuoshou_log.on_new_message = logger
    ...
    def run():
        ...
        while True:
            for e in events:
                ...
                #     zuikuihuoshou_log.error(getBacktrace())
