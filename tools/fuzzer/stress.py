...
from zuikuihuoshou.core.log import log as zuikuihuoshou_logger, Log
...
class Fuzzer:
    ...
    def __init__(self, filedb_dirs, error_dir):
        ...
        self.filedb = []
        self.tmp_file = "/tmp/stress-zuikuihuoshou"
        self.nb_error = 0
    ...
    def init(self):
        # Setup log
        self.nb_error = 0
        zuikuihuoshou_logger.use_print = False
        zuikuihuoshou_logger.on_new_message = self.newLog
