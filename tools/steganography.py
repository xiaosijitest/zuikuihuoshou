...
from zuikuihuoshou.editor import (createEditor as zuikuihuoshouCreateEditor,
...
from zuikuihuoshou.parser.image import PngFile
...
def createEditor(filename):
    ...
    return zuikuihuoshouCreateEditor(parser)
